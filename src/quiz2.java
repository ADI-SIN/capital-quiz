	...
	public class quiz2 extends JFrame {
		...
		public quiz2(){
			 ...
			 if(y1==z1 || y1+1==z1){
	          ...
	          op2=new JRadioButton(capital[z1+1]);
	          op3=new JRadioButton(capital[y1]);
	          op4=new JRadioButton(capital[z1]);
